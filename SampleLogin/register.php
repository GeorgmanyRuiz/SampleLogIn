...
<body style="background-color:#bdc3c7">
   ...
   <div id="main-wrapper">
    <center>
      ...
      <img id="uploadPreview" src="img/LoginAvatar.png" class="avatar"><br>
      <input type="file" id="imglink" name="imglink" accept=".jpg,.jpeg,.png" onchange="PreviewImage();"/>
    </center>


      <label><b>Full Name:</b></label><br>
      <input name="fullname" type="text" class="inputvalues" placeholder="Your Full Name" required/><br>
      ...
      <input class="signup" name="submit_btn" type="submit" id="signup_btn" value="Sign Up"/><br>
   ...
   <?php
       if (isset($_POST['submit_btn']))
       {
           ...
           {
             echo '<script type="text/javascript"> alert("Password and confirmed password does not match") </script>';
           }
       }
    ?>
   </div>
